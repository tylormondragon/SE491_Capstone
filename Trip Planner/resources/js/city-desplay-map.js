...
var url="https://www.triposo.com/api/20200405/location.json?part_of="+country+"&tag_labels=city&order_by=-score&count=100&fields=name,coordinates,images,snippet&account=I0OEOPWQ&token=0d843xcrheh2r5cz6qj5a0b1kos2qjbp";
...
.then( response => {
  ...
  for(var i = 0; i < s.length; i++) {
    ...
    temp = '{"type":"Feature","properties":{"name":'+name+',"snippet":'+snippet+',"images":"<img  src='+image+'>"},"geometry":{"type":"Point","coordinates":['+lon+','+lat+']}}';
...
function createPopUp(currentFeature) {
  ...
  var popup = new mapboxgl.Popup({closeOnClick: false})
    ...
    .setHTML('<h3>Top Locations </h3>'+' ' + 
    '<h3>'+ currentFeature.properties.name + '</h3>'+
    '<h4>' + currentFeature.properties.snippet + '</h4>'+
    '<img src=  '+currentFeature.properties.images+ '/>')
    .addTo(map);
}
